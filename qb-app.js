...
function renderPractice(){
  ...
  if(isText){document.getElementById('showTextAnswer').onclick=()=>{reviewOnly=true;submitted=true;drawTextAnswer(q,official);syncPracticeUi();afterAnswerShown()}}else{
...
function syncPracticeUi(){V.querySelectorAll('.choice').forEach(b=>b.disabled=submitted);const a=document.getElementById('answer');if(a){a.textContent=submitted?'もう一度解く':'解答する';a.disabled=submitted?false:!sel.size}const r=document.getElementById('review');if(r)r.disabled=submitted}
