...
const LABELS={stem:'問題文',explanation_overview:'問題文のポイント',examiner_intent:'出題者の意図',exam_summary:'試験用まとめ',medical_verification_note:'医学的検証メモ',explanation:'選択肢の解説',correction_text:'正しくすると',correct_for_other_context:'類題・補足',examiner_distinction:'見分けるポイント'};
...
.qbFmt-bold{font-weight:800}.qbFmt-underline{text-decoration-line:underline;text-underline-offset:.16em}.qbFmt-strike{text-decoration-line:line-through}.qbFmt-underline.qbFmt-strike{text-decoration-line:underline line-through}.qbFmt-marker{background:var(--accent-soft);color:inherit;box-decoration-break:clone;-webkit-box-decoration-break:clone}.qbFmt-accent{color:var(--accent);-webkit-text-fill-color:currentColor}.qbFmt-link{color:var(--accent,#126fb3)!important;-webkit-text-fill-color:currentColor;font-weight:800;background:var(--accent-soft,#eaf4fb);text-decoration-line:underline!important;text-decoration-style:dotted!important;text-decoration-thickness:2px!important;text-underline-offset:.2em;border-radius:3px;padding:0 .08em;box-decoration-break:clone;-webkit-box-decoration-break:clone}.qbFmt-linkIcon{margin-right:.12em;text-decoration:none!important}
