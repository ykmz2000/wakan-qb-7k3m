...
#qbReviewLaterPanel{padding:12px 13px;margin-bottom:10px;border:1px solid var(--accent-border,#cfe1ef);background:var(--accent-soft,#f8fcff);border-radius:15px}
#qbReviewLaterPanel .qbrlHead{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:8px}.qbrlTitle{font-size:20px;font-weight:900;color:var(--accent)}.qbrlCount{font-size:11px;color:var(--muted,#6f7786)}.qbrlActions{display:block}.qbrlBtn{width:100%;border:1px solid var(--accent-border,#cfe1ef);background:#fff;color:var(--accent);border-radius:11px;min-height:43px;padding:7px 8px;font-weight:900}.qbrlHint{margin-top:7px;font-size:10px;color:var(--muted,#6f7786);line-height:1.45}.qbReviewRowMark{display:inline-flex;align-items:center;justify-content:center;margin-left:7px;width:auto;height:auto;background:transparent;color:var(--accent);font-size:14px;font-weight:900;vertical-align:middle}.qbReviewPractice{margin-left:auto;display:flex;align-items:center;justify-content:center;flex:0 0 auto}.qbReviewPractice button{width:42px;height:42px;border:0;background:transparent;color:var(--muted,#6f7786);border-radius:0;padding:0;font-weight:900;font-size:29px;line-height:1;display:flex;align-items:center;justify-content:center}.qbReviewPractice button.on{background:transparent;color:var(--accent)}.qbReviewPractice button:disabled{opacity:.6}
@media(max-width:390px){#qbReviewLaterPanel{padding:10px}.qbrlBtn{font-size:12px}.qbReviewPractice button{width:38px;height:38px;font-size:26px}}
`;
