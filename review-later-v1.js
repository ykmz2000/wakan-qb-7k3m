...
#qbReviewLaterPanel .qbrlHead{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:8px}.qbrlTitle{font-size:20px;font-weight:900;color:#9a6d00}.qbrlCount{font-size:11px;color:#7f7350}.qbrlActions{display:block}.qbrlBtn{width:100%;border:1px solid #dacb91;background:#fff;color:#735f19;border-radius:11px;min-height:43px;padding:7px 8px;font-weight:900}.qbrlHint{margin-top:7px;font-size:10px;color:#837858;line-height:1.45}.qbReviewRowMark{display:inline-flex;align-items:center;justify-content:center;margin-left:7px;width:auto;height:auto;background:transparent;color:#c59000;font-size:14px;font-weight:900;vertical-align:middle}.qbReviewPractice{margin-left:auto;display:flex;align-items:center;justify-content:center;flex:0 0 auto}.qbReviewPractice button{width:42px;height:42px;border:0;background:transparent;color:var(--muted,#6f7786);border-radius:0;padding:0;font-weight:900;font-size:29px;line-height:1;display:flex;align-items:center;justify-content:center}.qbReviewPractice button.on{background:transparent;color:#c59000}.qbReviewPractice button:disabled{opacity:.6}
