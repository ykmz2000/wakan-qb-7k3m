...
#ans .qbMediaImg{max-height:340px!important;object-position:left center!important;margin:8px 0!important}
...
#ans .qbMediaHostV2>.qbPublicImageWrap{box-sizing:border-box;flex:0 1 300px;max-width:100%;min-width:0;margin:0!important}
...
function open(origin){
  ...
  function close(){
    ...
    locks.forEach(({el,value,priority})=>{if(value)el.style.setPropertyValue?.('overflow',value,priority);else el.style.removeProperty('overflow')});
